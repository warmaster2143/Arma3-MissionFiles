...
class JTS_Squad
{
	...
	class PLAYERS_T: JTS_GroupActiveText
	{
		idc = -1;
		text = "Units";
		toolTip = "Give leadership to this player";
	...
	class GROUPS_T: JTS_GroupActiveText
	{
		idc = -1;
		text = "Squad";
		toolTip = "Send request for the status of this player";
	...
	class JTS_PRIVACY: JTS_GroupActiveText
	{
		idc = -1;
		text = "Privacy";
		toolTip = "Allow/disallow send players a request for your status";
	...
	class EDIT: JTS_GroupEdit
	{
		idc = 0004;
		text = "";
		tooltip = "Allowed characters are: a-z, A-Z, 0-9";
	...
	class BUT1: JTS_GroupButton
	{
		idc = 0009;
		text = "JOIN";
		toolTip = "Join to selected player in the 'Squad' list";
	...
	class BUT2: JTS_GroupButton
	{
		idc = 0010;
		text = "LEAVE";
		toolTip = "Leave your current squad and be the squad leader";
	...
	class BUT3: JTS_GroupButton
	{
		idc = 0011;
		text = "INVITE";
		toolTip = "Invite the selected player into your squad";
	...
	class BUT4: JTS_GroupButton
	{
		idc = 0012;
		text = "LOCK";
		toolTip = "Lock your squad with password. Allowed characters are: a-z, A-Z, 0-9. To delete your password, leave the input field empty";
	...
	class BUT5: JTS_GroupButton
	{
		idc = 0013;
		text = "KICK";
		toolTip = "Kick the selected player in the 'Units' list. You can't kick any player, if he is not in your squad or you are not the squad leader";
	...
	class BUT6: JTS_GroupButton
	{
		idc = 0014;
		text = "REFRESH";
		toolTip = "Refresh the 'Squad' list";
	...
	class BUT7: JTS_GroupButton
	{
		idc = -1;
		text = "CLOSE";
		toolTip = "Exit this menu and return to the game";
